...
import { ExploreFeatureP5, LearnFeatureP5, PlayFeatureP5, StudyFeatureP5 } from './FeatureP5';
    ...
    return (
        <header className="flex justify-between items-center p-4">
            ...
            <nav>
                ...
                <a href="#sketches" className="mx-2">sketches</a>
